...
export default function ProductId({ params }: {
    ...
    return (
        ...
        <div className="flex flex-col items-start w-full h-fit pb-20 lg:pb-60 lg:px-12">
            <main className="w-full flex flex-col gap-y-8 h-fit lg:flex-row lg:justify-between">
